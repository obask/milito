...
import { gameRooms, gamePlayers, gameState, games } from '../../../platform/server/db/schema.js'
...
const militoRoutes = new Elysia({ prefix: '/api/milito' })
  .use(authMiddleware)
  .get(
    '/:roomId/state',
...
export const militoPlugin: GamePlugin = {
  id: 'milito',
  name: 'Milito',
  minPlayers: 2,
  maxPlayers: 2,
