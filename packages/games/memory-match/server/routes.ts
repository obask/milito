...
import { db } from '../../../platform/server/db/index.js'
import { gameRooms, gamePlayers, gameState } from '../../../platform/server/db/schema.js'
import { eq, and } from 'drizzle-orm'
import { authMiddleware } from '../../../platform/server/middleware/auth.js'
import type { GamePlugin } from '../../../platform/server/game-plugin.js'
import type { MemoryCard, MemoryMatchState } from '../shared/types.js'
...
const memoryMatchRoutes = new Elysia({ prefix: '/api/gameplay' })
  .use(authMiddleware)
  .get(
    '/:roomId/state',
