...
import { LogIn, Mail, Lock, AlertCircle, FlaskConical } from 'lucide-solid'
      ...
      <div class="w-full max-w-md">
        <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl shadow-2xl p-8">
          ...
          <button
            ...
            class="mt-6 w-full py-3 px-4 bg-slate-700 hover:bg-slate-600 text-gray-300 font-medium rounded-lg border border-slate-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
