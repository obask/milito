  ...
  const features = [
    {
      ...
      description:
        'Single-runtime React app with server routes for auth and game APIs.',
    },
    {
    ...
    },
    {
      ...
      title: 'Modern Stack',
      description:
        'React + TanStack Start with Drizzle ORM and SQLite.',
    },
  ]
      ...
      <section className="relative py-20 px-6 text-center overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <p className="text-2xl md:text-3xl text-gray-300 mb-4 font-light">
            Ancient tactical card game platform
          </p>
          <p className="text-lg text-gray-400 max-w-3xl mx-auto mb-8">
            Built with TanStack Start, React, Drizzle, and Better Auth. Server-rendered routes, secure authentication, and game APIs run in one app.
          </p>
